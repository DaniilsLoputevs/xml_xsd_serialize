...
4. В чём недостатки ORM? Как их решать\избегать?
   ...
   * В случаи ORM framework сломался и нужно чинить - бывает очень не просто понят что-где-почему-когда пошло нетак
...
7. В чём недостатки аннотаций и рефлексии?
   * Аннотации
     ...
     * Ограниченная расширяемость - 
       ...
       * Нет Возможности писать Кастомные типы в свойствах/полях аннотации, только Примитивы, Массивы, Class<?> и Enum
   * Рефлекция
     ...
     * Ухудшение производительности - Рефлексия это про Возможности, а не про Быстро...
     * Потеря статической типизации - Рефлекцися это runtime + Object object - легко можно отстрелить конечности и к печали ТимЛида, только себе и уже к трагедии - не сразу.   
